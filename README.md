...
## Описание
В данном проекте предстоит решить задачу привлечения клиентов банка для открытия депозита. Банком были предоставлены данные о последней маркетинговой компании, которую проводил банк.
<br><br>
